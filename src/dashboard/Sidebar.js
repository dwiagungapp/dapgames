...
const SideBar = forwardRef(({ showNav }, ref) => {
  ...
  return (
    <div ref={ref} className="font-poppins fixed w-56 h-full bg-white shadow-sm border-r-2 border-gray-100 z-20">
        ...
        <div
          className={`pl-6 py-3 mx-5 rounded text-center cursor-pointer mb-3 flex items-center transition-colors ${
            location.pathname === "/"
              ...
              : "text-gray-400 hover:bg-orange-200 hover:text-[#ff8f00]"
          }`}
